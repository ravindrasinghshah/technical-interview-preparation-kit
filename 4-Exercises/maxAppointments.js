/**
 * cd to 4-Exercises folder and then run "node maxAppointments.js"
...
let s = [1, 3, 0, 5, 8, 5], f = [2, 4, 6, 7, 9, 9];
maxAppointments(s, f);

console.log(`=================`);
s = [75250, 50074, 43659, 8931, 11273, 27545, 50879, 77924], f = [112960, 114515, 81825, 93424, 54316, 35533, 73383, 160252];
maxAppointments(s, f);