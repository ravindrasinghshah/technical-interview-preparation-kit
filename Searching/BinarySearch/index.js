/**
 * cd to BinarySearch folder and then run "node index.js"
...
function binarySearch(nums, target) {
    ...
    while (left <= right) {
        ...
        if (nums[midIndex] > target) right = midIndex - 1; //== no, then it means value is in the right half of the array
        else left = midIndex + 1; //== this means value is in the left half of the array
    }
    return left;
}
